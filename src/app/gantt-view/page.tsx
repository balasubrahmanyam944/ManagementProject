...
export default function GanttViewPage() {
  ...
  // Detect project type based on ID format (same logic as project details page)
          ...
          try {
            if (detectedType === 'trello') {
              ...
              if (response.success && response.testCases) {
                // Convert TestRail test cases to Jira-like issues for Gantt compatibility
  ...
  // Combine all issues from selected projects with project info
