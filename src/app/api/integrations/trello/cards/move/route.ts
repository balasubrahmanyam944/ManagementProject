...
/**
 * GET /api/integrations/trello/cards/move?boardId=xxx
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 TRELLO CARDS API: Fetching lists for board:', boardId)
    ...
    console.error('❌ TRELLO CARDS API: Error:', error)
    return NextResponse.json(
...
/**
 * POST /api/integrations/trello/cards/move
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔄 TRELLO CARDS API: Moving card:', cardId, 'to list:', listId)
