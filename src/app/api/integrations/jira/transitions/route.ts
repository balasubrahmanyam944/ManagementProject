...
/**
 * GET /api/integrations/jira/transitions?issueKey=PROJ-123
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 JIRA TRANSITIONS API: Fetching transitions for:', issueKey)
...
/**
 * POST /api/integrations/jira/transitions
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔄 JIRA TRANSITIONS API: Transitioning issue:', issueKey, 'to:', transitionId)
