...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('❌ WEBHOOK MANAGE: Error getting status:', error)
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔗 WEBHOOK MANAGE: Registering webhooks for:', integration)
    console.log('🔗 WEBHOOK MANAGE: Base URL:', baseUrl)
    console.log('🔗 WEBHOOK MANAGE: Base Path:', basePath)
    ...
    console.error('❌ WEBHOOK MANAGE: Error registering:', error)
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('🔗 WEBHOOK MANAGE: Unregistering webhooks for:', integration)
    ...
    console.error('❌ WEBHOOK MANAGE: Error unregistering:', error)
    return NextResponse.json(
